...
from src.scheduler import LottoScheduler
...
def parse_arguments():
    ...
    parser.add_argument('--predict', action='store_true',
                        help='Generate lottery predictions')
...
def main():
    ...
    if not (args.scrape or args.analyze or args.predict or args.schedule or args.web or args.all):
